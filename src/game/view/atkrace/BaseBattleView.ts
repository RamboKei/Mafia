...
class BaseBattleView extends CommonView
{
	...
	protected showBeAttackAnim():void
	{
		...
		this._beAttackClip.setPosition(this._heroArray[1].x + this._heroArray[1].width/2 - tempBitmap.width/2 ,hitY);
		...
		this._damageText.setPosition(this._heroArray[1].x + this._heroArray[1].width/2 - this._damageText.width/2 ,damageY);
