	...
	{	
		...
		if(this._atkraceInfoVoList.length>0&&this._atkraceInfoVoList[0].info)
		{
			...
			{	
				...
				describeTxt.text =LanguageManager.getlocal(desStr,[currName,str,data.info.uname2,data.info.fightnum,data.info.streak]);
			}
			else
			{	
				...
				describeTxt.text =LanguageManager.getlocal(desStr2,[currName,str,data.info.uname2,data.info.fightnum]);
			}
