...
{   
	...
	protected initView():void
	{
		...
		let inputTF4 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_COMMON,466,100,"public_9_probiginnerbg",LanguageManager.getlocal("allianceCreateMsgholder"),0xb1b1b1,allianceVo.message);
		inputTF4.x = 50;
		...
		let inputTF5 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_COMMON,466,100,"public_9_probiginnerbg",LanguageManager.getlocal("allianceCreateMsgholder"),0xb1b1b1,allianceVo.intro);
		inputTF5.x = 50;
