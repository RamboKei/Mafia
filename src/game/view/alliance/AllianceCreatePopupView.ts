...
{   
	...
	protected initView():void
	{
		...
		let inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL,466,45,"public_9_bg5",LanguageManager.getlocal("allianceCreateWeixinholder"),0xb1b1b1);
		...
		let inputTF3 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL,466,45,"public_9_bg5",LanguageManager.getlocal("allianceCreateQQholder"),0xb1b1b1);
		...
		let inputTF5 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL,466,134,"public_9_bg5",LanguageManager.getlocal("allianceCreateMsgholder"),0xb1b1b1);
