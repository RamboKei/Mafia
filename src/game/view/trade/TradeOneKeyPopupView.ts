...
class TradeOneKeyPopupView  extends PopupView
{
	...
	protected initView():void
	{
		...
		iconBg3.setPosition(35,20);
		this.addChildToContainer(iconBg3);
		
		let resImg3 = BaseBitmap.create("public_icon2");
		resImg3.setPosition(iconBg3.x-resImg3.width/2+20,iconBg3.y-2);//iconBg3.y+iconBg3.height-resImg3.height+5);
		...
		attText.setPosition(85,iconBg3.y + iconBg3.height/2 - attText.height/2);
		this.addChildToContainer(attText);

		let effectTitle:string = LanguageManager.getlocal("effectTitle");

		let cu_bg:BaseBitmap = BaseBitmap.create("public_9_bg4");
		cu_bg.width = 520;
		cu_bg.height = 220;
		...
		this._carNumTF.setPosition(50,bottomBg.y + 15);
