...
class EmperorWarRewardViewTab1 extends CommonViewTab
{
	...
	protected initView():void
	{
		...
		view.setLayoutPosition(LayoutConst.horizontalCentertop, winBottomBg, view, [-10,20]);
		...
		for (var index = 1; index <= 3; index++){
			...
			view.setLayoutPosition(LayoutConst.leftverticalCenter, prerogativIcon, winBottomBg, [230 + (45 + 82) * (index - 1),20]);
		...
		let scrollList  = ComponentManager.getScrollList(EmperorWarRewardScrollItem, arr, new egret.Rectangle(viewbg.x, winBottomBg.y + winBottomBg.height, viewbg.width - 60, viewbg.height - winBottomBg.height - 90));
		view.setLayoutPosition(LayoutConst.horizontalCentertop, scrollList, viewbg, [0,winBottomBg.y+winBottomBg.height + 10 - viewbg.y]);
