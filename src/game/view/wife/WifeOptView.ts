...
class WifeOptView extends CommonView {
	...
	public initView(): void {
		...
		bigBg.y = GameConfig.stageHeigth - bigBg.height - 120;
	...
	private loveHander(){
		...
		ViewController.getInstance().openView(ViewConst.POPUP.ITEMUSECONSTPOPUPVIEW,{useNum:needGem-costV,confirmCallback:this.confirmCallbackHandler,handler:this,icon:"itemicon1",iconBg: "itembg_1",num:gem,msg:message,id : 1});
