...
class PracticeView extends CommonView
{
	...
	{	
		...
		{
			this._bottomnodeContainer.y = infoH;
			bottomBg.height = targetHeight - bottomBg.y;
		}
	...
	{	
		...
		let servant_upgrade_word:BaseBitmapText|BaseTextField = ComponentManager.getBitmapText(LanguageManager.getlocal("servant_xLv",[String(addLv)]),TextFieldConst.FONTNAME_BOSS_SCORE);
