...
class DecreePaperChoosePopupView extends PopupView
{
	...
	protected initView():void
	{
		...
		let numTF:BaseTextField = ComponentManager.getTextField(costNUm.toString(),TextFieldConst.FONTSIZE_CONTENT_SMALL);;
		...
		chooseTxt1.text = LanguageManager.getlocal("decreeChooseTxt1",[""+costNUm,decreeName]);
		...
		chooseTxt3.text = LanguageManager.getlocal("decreeChooseTxt3");
