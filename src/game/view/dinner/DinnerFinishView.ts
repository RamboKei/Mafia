...
{	
	...
	protected initView():void
	{
		...
		let totalGuest:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("dinnerTotalGuest",[info.num.toString()]),TextFieldConst.FONTSIZE_TITLE_SMALL);
