...
class QqvideoguideView  extends BaseView
{
    ...
    { 
        ...
        let collectBtn = BaseBitmap.create("public_alphabg");
        collectBtn.width = 100;
        collectBtn.height = 50;
        collectBtn.addTouchTap(this.okClick,this);
        collectBtn.x =  GameConfig.stageWidth/2 - collectBtn.width/2;
        collectBtn.y = acImg.y + acImg.height * acImg.scaleY - 30 ;
        ...
        goBtn.y = acImg.y + acImg.height * acImg.scaleY  - 170 ;
        this.addChild(goBtn);
    ...
    protected goClick()
    {
        let urlPath = "https://iwan.qq.com/m/vadr/h5games.htm"
