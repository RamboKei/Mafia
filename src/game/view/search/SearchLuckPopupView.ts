class SearchLuckPopupView extends PopupView
{
	...
	protected initView():void
	{
		...
		let autoLuckTxt:BaseTextField=ComponentManager.getTextField(LanguageManager.getlocal("searchLuckAutoDonate"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		numBg.width=100;
		numBg.setPosition(120,bg2.y+bg2.height-numBg.height-20);
