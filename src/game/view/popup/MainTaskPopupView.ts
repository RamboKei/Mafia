...
class MainTaskPopupView  extends PopupView
{
	...
	protected initView():void
	{
		...
		let deltaY = 35;
		let taskNameTxt = ComponentManager.getTextField("",TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_WARN_YELLOW);
		taskNameTxt.x = 60;
		taskNameTxt.y = 25;
		this._nodeContainer.addChild(taskNameTxt);
		this._taskNameTxt = taskNameTxt;

		let taskDescTxt = ComponentManager.getTextField("",TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		let taskAimTxt = ComponentManager.getTextField("",TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		let taskRewardTxt = ComponentManager.getTextField(LanguageManager.getlocal("taskReward"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		let goBtn:BaseButton = ComponentManager.getButton(ButtonConst.BTN_BIG_YELLOW,"taskGoBtn",this.goHandler,this);
