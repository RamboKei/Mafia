 ...
 */
class ConquestRankPopupView extends PopupView
{
	// 滑动列表
	...
	{		
        ...
        // }
        let titleTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("conquestScore"),titleTxt1.size,TextFieldConst.COLOR_LIGHT_YELLOW)
		...
		let dataList = this._acData.conrank;
