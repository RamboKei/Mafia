...
class AcPunishRankRewardPopupView extends PopupView
{
	...
	{		
		...
		this._acVo = <AcPunishVo>Api.acVoApi.getActivityVoByAidAndCode(AcPunishRankRewardPopupView.aid,AcPunishRankRewardPopupView.code);
		...
		//初始化 时间
		let acCfg = Config.AcCfg.getCfgByActivityIdAndCode("punish", AcPunishRankRewardPopupView.code);
		...
		let cfg = Config.AcCfg.getCfgByActivityIdAndCode("punish", AcPunishRankRewardPopupView.code);
