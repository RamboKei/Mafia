...
class AcDragonBoatDayRankView extends PopupView
{
	...
	{		
        ...
        this._titleTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("DragonBoatDayZziNum_"+AcDragonBoatDayView.CODE), this._titleTxt1.size,TextFieldConst.COLOR_LIGHT_YELLOW)
        ...
        this._scoreTF.text = LanguageManager.getlocal("DragonBoatDayMYRankNum_"+AcDragonBoatDayView.CODE,[this.vo.getZongzi().toString()]);
        ...
        this._sendTip = ComponentManager.getTextField(LanguageManager.getlocal("DragonBoatDayTip_"+AcDragonBoatDayView.CODE,[this.cfg.rankNeed.toString()]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
