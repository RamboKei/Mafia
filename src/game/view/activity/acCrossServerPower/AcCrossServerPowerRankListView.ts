...
{	
    ...
    public initView():void
	{
		...
		let socreText:BaseTextField = ComponentManager.getTextField((LanguageManager.getlocal(`croessPowerScore-${this.vo.code}`)+': '), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
