...
class AcDoubleSeventhAwardScrollItem  extends ScrollListItem
{
    ...
    protected initItem(index:number,data:any)
    {
        ...
        let buildTxt = ComponentManager.getTextField(LanguageManager.getlocal(`acDoubleSeventhViewBuild${key}`), 22, TextFieldConst.COLOR_BLACK);
        ...
        let descTxt = ComponentManager.getTextField(LanguageManager.getlocal(`acDoubleSeventhChargeItem`, [view.cfg.recharge[key].needGem.toString(), buildTxt.text]), 18, TextFieldConst.COLOR_BLACK);
