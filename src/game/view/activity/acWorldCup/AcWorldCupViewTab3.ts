...
desc : 世界杯活动
*/
class AcWorldCupViewTab3 extends CommonViewTab
{
	//滑动列表
	...
	{	
		...
		let scrollList = ComponentManager.getScrollList(AcWorldCupTab3Item,arr,tmpRect);
		...
		view.setLayoutPosition(LayoutConst.rightbottom, descTxt, listBg, [10,5]);
	...
	private update() :void{
		...
		this._scrollList.refreshData(taskArr);
	}
