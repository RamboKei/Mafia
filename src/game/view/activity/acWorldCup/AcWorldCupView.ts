...
class AcWorldCupView extends AcCommonView{
    ...
    private get cfg() : Config.AcCfg.WorldCupCfg{
        return Config.AcCfg.getCfgByActivityIdAndCode(AcWorldCupView.AID, AcWorldCupView.CODE);
    }

    private get vo() : AcWorldCupVo{
        return <AcWorldCupVo>Api.acVoApi.getActivityVoByAidAndCode(AcWorldCupView.AID, AcWorldCupView.CODE);
    }
    ...
    public initView(){
        ...
        AcWorldCupView.AID = view.aid;
        AcWorldCupView.CODE = view.code; 
        ...
        view.setLayoutPosition(LayoutConst.leftverticalCenter, myPointsTxt, view._pointsGroup, [0,0], true);
        ...
        //top背景图
        let _topBg:BaseBitmap = BaseBitmap.create(`worldcuptopbg-${AcWorldCupView.CODE}`);
        ...
        //活动描述
        view._activityDescText = ComponentManager.getTextField(LanguageManager.getlocal(`AcWorldCupRuleInfo-${AcWorldCupView.CODE}`), TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        //targroup
        view.setLayoutPosition(LayoutConst.lefttop, view.tabbarGroup, _topBg, [15,_topBg.height + 22]);
        //bottombg
