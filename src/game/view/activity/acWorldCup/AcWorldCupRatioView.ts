...
class AcWorldCupRatioView extends PopupView
{
	...
	protected initView():void
	{
		...
		kuang.width = 518;
		kuang.height = 454;
		view.setLayoutPosition(LayoutConst.horizontalCentertop, kuang, view.viewBg, [0,60]);
		view.addChild(kuang);
		...
		let scrollList = ComponentManager.getScrollList(AcWorldCupGuessRatioItem, arr, tmpRect);
