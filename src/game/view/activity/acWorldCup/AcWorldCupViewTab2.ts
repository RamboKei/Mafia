...
desc : 世界杯竞猜活动
*/
class AcWorldCupViewTab2 extends CommonViewTab
{
	...
	{	
		...
		let scrollList = ComponentManager.getScrollList(AcWorldCupTab2Item, [], tmpRect);  
	...
	private fresh_day():void{
		let view = this;
		view._list.refreshData(view.vo.getGuessInfo());
