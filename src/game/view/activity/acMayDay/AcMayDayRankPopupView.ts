...
class AcMayDayRankPopupView extends PopupView
{
	...
	{		
		...
		this._sendDesc = ComponentManager.getTextField(LanguageManager.getlocal(this.vo.code == 1 || this.vo.code == 3 || this.vo.code == 4? "acRanktip3" : "acRanktip"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
