    ...
    private updateView()
    {
        ...
        else
        {
            ...
            if(this.vo.getChargeNum() < this._rewardData.needGem)
            {
                ...
                if(rechargeBtn == null)
                {
                    rechargeBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_RED,"acCarnivalToChargeBtnText",this.rechargeHandler ,this);
                }
            ...
            else
            {
                ...
                if(receiveBtn == null)
                {
                    receiveBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW,"ac_recharge_Btntxt2",this.receiveHandler ,this);
                }
