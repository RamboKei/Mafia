...
class AcArcherView extends AcCommonView {
	...
	protected getResourceList(): string[]
	{
		...
		"acturantable_taskbox_light","empshop_tag","accarnivalview_tab_red","itemeffect","progress5","progress3_bg",
		"collectflag","rank_1","rank_2","rank_3","punish_ani54_0","punish_ani54","acarcherview_archer","acarcherview_bg","acarcherview_hurt","acarcherview_wall",
	...
	{	
		...
		let discountTF:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("discountTitle",[String(this.cfg.discount * 10 )]),TextFieldConst.FONTSIZE_ACTIVITY_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
