...
class AcArcherRankPopupView extends PopupView{
	...
	public initView()
	{
		...
		this._rankTF.setPosition(this._rankTopBg.x + 35,this._rankTopBg.y + this._rankTopBg.height / 2 - this._rankTF.height / 2);
		...
		this._rankPlayNameTF.setPosition(this._rankTopBg.x + this._rankTopBg.width / 2 - this._rankPlayNameTF.width / 2,this._rankTF.y);
		...
		this._rankKillNumTF.setPosition(this._rankTopBg.x + this._rankTopBg.width - this._rankKillNumTF.width  - 75,this._rankTF.y);
