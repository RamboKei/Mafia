...
class AcCrossServerDetailPopupView extends PopupView
{
	...
	protected initView():void
	{
		...
		let topPic:BaseBitmap = BaseBitmap.create(`crossserverinti_detailbg-${this.vo.code}`);
		...
		let rankDesc:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal(`crossImacyDetailDesc1-${this.vo.code}`), TextFieldConst.FONTSIZE_CONTENT_SMALL);
		...
		let persionDesc:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal(`crossImacyDetailDesc2-${this.vo.code}`), 19);
