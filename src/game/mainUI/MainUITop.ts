class MainUITop extends BaseLoadDisplayObjectContiner
{
	...
	protected init():void
	{
		...
		this._powerValueText.setPosition(headImg.x+100,headBg.y+12);
	...
	public refresh():void
	{
		...
		this._powerValueText.text = LanguageManager.getlocal("mainui_shili")+Api.playerVoApi.getPlayerPower();
		if(this._isShowName)
		{
			this._nickNameText.text = Api.playerVoApi.getPlayerName();
