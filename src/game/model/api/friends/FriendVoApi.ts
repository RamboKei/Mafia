...
class FriendVoApi extends BaseVoApi
{
	...
	{
		return Object.keys(this.friendVo.receive).length > 0;
	}

	public getFriendsCount()
	{
		return Object.keys(this.friendVo.info).length;
	}
	public getApplyCount()
	{
		return Object.keys(this.friendVo.apply).length;
	}
	...
	{
		return this.isShowRedForItem3() || this.isGiftCollectEnable() ;
	}
