...
{	
	...
	{
		return Api.playerVoApi.getPlayerLevel() >= Config.DinnerCfg.getNeedLv();
	}

	public getLockedString():string
	{
		return LanguageManager.getlocal("reachLvelUnlockDesc",[Api.playerVoApi.getPlayerOfficeByLevel(Config.DinnerCfg.getNeedLv())]);
	}
	...
	{
		return this.dinnerVo.totalNum;
	}
	public setTotalNumber(n:number):void
	{
		this.dinnerVo.totalNum = n;
	}
