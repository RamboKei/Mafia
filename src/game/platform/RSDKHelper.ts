namespace RSDKHelper 
{
	...
	export function init():void
	{
        ...
        if (App.DeviceUtil.isWXgame()) {        
            initInfo.r_host = "https://gd-dujiaoshou-sdk.raygame3.com";
            initInfo.r_bid = "17023000";
            initInfo.r_plat = "h5dujiaoshou-17023001";
    ...
    export function login():void
    {
        RSDK.login("",function(code,data)
        {
            ...
            if(Number(code)==0)
            {
                ...
                if (data.inviter_uid) {
                    let customData = data.inviter_uid.split("#");                
    ...
    export function pay(productId:string):void
    {
        ...
        {
            let pData:any={allProductId:Config.RechargeCfg.getAllProductid().join(",")};
            formatChannelId(pData);
            payInfo.privateData=JSON.stringify(pData);
        }
    ...
    function realPay(payInfo:productInfo,itemCfg:Config.RechargeItemCfg):void
    {
    ...
    export function setShareInfo(shareInfo:string): void
    {
        ...
        App.ShareGuideUtil.sharingId = shareId;
        RSDK.setShareInfo(content, shareInfo + "#" + shareId);
    }
    ...
    export function guideShare(shareContent, callback, shareId) {        
        ...
        App.ShareGuideUtil.sharingId = shareId;
        RSDK.setShareInfo(shareContent, GameData.userId.toString() + "#" + shareId);
    ...
    export function setShareInfoGuide(shareContent, shareInfo:string, shareId:string): void
    {
        ...
        App.ShareGuideUtil.sharingId = shareId;
        RSDK.setShareInfo(shareContent, shareInfo + "#" + shareId);
    }
    /**
     * 
