namespace PlatformManager
{
	...
	{ 
		try{
			...
			{
				if (RSDK.getAppid()== "17026001" && App.DeviceUtil.isIOS())
				{
					return "17026002";
				}
	...
	export function checkIsTextHorizontal():boolean
	{
		...
		if(App.DeviceUtil.IsHtml5())
		{
			...
			return  checkIsEnSp()||checkIsThSp();
		}
		return false;
	}
	...
	export function checkIsTySp():boolean
	{
		...
		{
			let pathname:string=window.location.pathname;
			return pathname.indexOf("_ty")>-1||pathname.indexOf("_testty")>-1;
		}
		return false;
	}
	...
	export function checkIsJjSp():boolean
	{
		...
		{
			let pathname:string=window.location.pathname;
			return pathname.indexOf("_jj")>-1||pathname.indexOf("_testjj")>-1;
		}
		return false;
	}
	...
	export function checkIsKr37Sp():boolean
	{
		...
		{
			let pathname:string=window.location.pathname;
			return pathname.indexOf("_kr37")>-1||pathname.indexOf("_testkr37")>-1;
		}
		return false;
	}
	export function checkIsThSp():boolean
	{
		...
		{
			let pathname:string=window.location.pathname;
			return App.CommonUtil.getOption("language")=="th" || pathname.indexOf("_th")>-1||pathname.indexOf("_testth")>-1;
		}
		return false;
	}
	...
	export function checkIsTWCNSp():boolean
	{
		...
		{
			let pathname:string=window.location.pathname;
			return pathname.indexOf("_twcn")>-1||pathname.indexOf("_testtwcn")>-1;
		}
		return false;
	}
	...
	{
		if (checkIsTWBSp()||checkIsKRSp()||checkIsThSp()) {
			return false;
		}
		else {
			return true;
	...
	export function checkHideSwitchAccountBtn():boolean
	{
		...
		App.DeviceUtil.isWXgame()||
		App.DeviceUtil.isWyw();
	}
	...
	export function checkIsHeYue():boolean
	{
		...
		{
			return (PlatformManager.checkIsEnSp()==true || PlatformManager.checkIsTWBSp()==true || PlatformManager.checkIsTWShenheSp()==true || PlatformManager.getBigAppid() == "17004000")||
			(PlatformManager.checkIsThSp()||Number(PlatformManager.getBigAppid())==17027000);
		}
	}
	...
	export function checkIsShenHeShowCard():boolean{
		...
		|| PlatformManager.getSpName().indexOf("iosgnetop")>-1)
		{
			return true;
		}
		return false;
	...
	{	 
		...
		{
			//1 纯粤语 
			if(PlatformManager.getAppid() == "17004015" || PlatformManager.getAppid() == "17004014")
			{
				return 1;
			}
			else
