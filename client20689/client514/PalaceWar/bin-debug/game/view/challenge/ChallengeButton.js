...
var ChallengeButton = (function (_super) {
    ...
    ChallengeButton.prototype.initButton = function (callback, handler, idx) {
        this._idx = idx;
    ...
    ChallengeButton.prototype.showBoss = function () {
        ...
        var challengeConfig = ChallengeCfg.getChallengeCfgById(Api.challengeVoApi.getCurBigChannelId() * 41);
