...
var DinnerFindPopupView = (function (_super) {
    ...
    DinnerFindPopupView.prototype.initView = function () {
        ...
        var inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 44, "public_9_bg5", LanguageManager.getlocal("inputPlayerId"), 0xa4917f);
    ...
    DinnerFindPopupView.prototype.showFindInfo = function () {
        ...
        var dinnerHost = ComponentManager.getTextField(LanguageManager.getlocal("dinnerHost"), TextFieldConst.FONTSIZE_CONTENT_COMMON);
        this._dinnerInfoContainer.addChild(dinnerHost);
        var dinnerType = ComponentManager.getTextField(LanguageManager.getlocal("dinnerType"), TextFieldConst.FONTSIZE_CONTENT_COMMON);
        dinnerType.y = 33;
        this._dinnerInfoContainer.addChild(dinnerType);
        var dinnerSeat = ComponentManager.getTextField(LanguageManager.getlocal("dinnerSeat") + ":", TextFieldConst.FONTSIZE_CONTENT_COMMON);
        dinnerSeat.y = 66;
        this._dinnerInfoContainer.addChild(dinnerSeat);
        var dinnerCountDown = ComponentManager.getTextField(LanguageManager.getlocal("dinnerCountDown"), TextFieldConst.FONTSIZE_CONTENT_COMMON);
