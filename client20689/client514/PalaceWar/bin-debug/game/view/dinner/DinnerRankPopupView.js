...
var DinnerRankPopupView = (function (_super) {
    ...
    DinnerRankPopupView.prototype.initView = function () {
        ...
        var tabbarGroup = ComponentManager.getTabBarGroup(ButtonConst.BTN_TAB, tabName, null, null);
        tabbarGroup.x = 40;
        tabbarGroup.y = 10;
        this.addChildToContainer(tabbarGroup);
        var rankDesc = ComponentManager.getTextField(LanguageManager.getlocal("dinnerRankDesc"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BLACK);
