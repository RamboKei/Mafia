...
var WelfareViewFirstRecharge = (function (_super) {
    ...
    WelfareViewFirstRecharge.prototype.showWanbaPanel = function () {
        ...
        var nameTF = ComponentManager.getTextField(LanguageManager.getlocal("firstRecharge"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        if (payflag == 0) {
            ...
            for (var i = 0; i < rechargeArr.length; i++) {
                ...
                var btnStr = LanguageManager.getlocal("firstRecharge" + (i + 1), [rechargeArr[i] + ""]);
