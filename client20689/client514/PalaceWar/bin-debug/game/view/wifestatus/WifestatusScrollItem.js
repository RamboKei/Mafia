...
var WifestatusScrollItem = (function (_super) {
    ...
    WifestatusScrollItem.prototype.initItem = function (index, data) {
        ...
        // }
        this._titleBB = BaseBitmap.create("wifestatus_title" + id);
    ...
    WifestatusScrollItem.prototype.showIcons = function (index, data) {
        ...
        var addH = 140 * (Math.ceil((wifenum) / 4));
        if (data.id == "1") {
            var num_1 = Api.wifestatusVoApi.getNoStatusWife().length;
            addH = 140 * (Math.ceil((num_1) / 4));
        }
        if (!addH) {
            addH = 0;
    ...
    WifestatusScrollItem.prototype.getWifestatusIcon = function (data, wifeId) {
        ...
        var nameTF = ComponentManager.getTextField(wifeCfg.name, TextFieldConst.FONTSIZE_CONTENT_SMALL);
    ...
    WifestatusScrollItem.prototype.showUnlockAni = function () {
        ...
        var upgradeClip = ComponentManager.getCustomMovieClip("wifestatus_unluck", 11, 150);
        ...
        var upgradeClip2 = ComponentManager.getCustomMovieClip("wifestatus_unluck", 11, 150);
        // let upgradeClip = ComponentManager.getCustomMovieClip("wifestatus_frame",5,100);
        ...
        var text1 = BaseBitmap.create("wifestatus_itemeffect");
        // text1.setScale(2)
        text1.x = -7;
        text1.y = -4;
        text1.alpha = 0;
