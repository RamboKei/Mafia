...
var AcLimitedRewardDetailScrollItem = (function (_super) {
    ...
    AcLimitedRewardDetailScrollItem.prototype.initItem = function (index, data) {
        ...
        var progress = "(" + App.StringUtil.changeIntToText(acLimitedRewardVo.v) + "/" + App.StringUtil.changeIntToText(this._limitedRewardInfoVo.condition) + ")";
    ...
    AcLimitedRewardDetailScrollItem.prototype.clickGetBtnHandler = function (param) {
        if (Api.acVoApi.checkActivityStartByAid(this._limitedRewardInfoVo.aid)) {
