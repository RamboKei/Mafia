...
var AcNewYearViewTab1 = (function (_super) {
    ...
    AcNewYearViewTab1.prototype.initView = function () {
        ...
        for (var i = 0; i < needScoreArr.length; i++) {
            ...
            downbottomTxt.setPosition(downbottom.x + 15, this.newYearCfg[i].acnewyearPosY);
        ...
        var scrollList = ComponentManager.getScrollList(NewYear1ScrollItem, this._arrReward, tmpRect);
