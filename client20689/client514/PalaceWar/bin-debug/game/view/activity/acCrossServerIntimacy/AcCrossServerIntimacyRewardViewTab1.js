...
//
var AcCrossServerIntimacyRewardViewTab1 = (function (_super) {
    __extends(AcCrossServerIntimacyRewardViewTab1, _super);
    function AcCrossServerIntimacyRewardViewTab1() {
    ...
    Object.defineProperty(AcCrossServerIntimacyRewardViewTab1.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyRewardViewTab1.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyRewardViewTab1.prototype, "api", {
        get: function () {
    ...
    AcCrossServerIntimacyRewardViewTab1.prototype.getListType = function () {
        return 1;
    };
    AcCrossServerIntimacyRewardViewTab1.prototype.initView = function () {
    ...
    AcCrossServerIntimacyRewardViewTab1.prototype.collectHandler = function () {
        var crossVo = this.vo;
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_AWARD, { activeId: crossVo.aid + "-" + crossVo.code });
    };
    AcCrossServerIntimacyRewardViewTab1.prototype.collectHandlerCallBack = function (event) {
    ...
    AcCrossServerIntimacyRewardViewTab1.prototype.tick = function () {
    ...
    AcCrossServerIntimacyRewardViewTab1.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    AcCrossServerIntimacyRewardViewTab1.prototype.createCollectFlag = function () {
    ...
    AcCrossServerIntimacyRewardViewTab1.prototype.dispose = function () {
    ...
    return AcCrossServerIntimacyRewardViewTab1;
}(CommonViewTab));
__reflect(AcCrossServerIntimacyRewardViewTab1.prototype, "AcCrossServerIntimacyRewardViewTab1");
