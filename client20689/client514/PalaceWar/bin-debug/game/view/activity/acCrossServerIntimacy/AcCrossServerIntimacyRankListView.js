...
var AcCrossServerIntimacyRankListView = (function (_super) {
    ...
    AcCrossServerIntimacyRankListView.prototype.initView = function () {
        ...
        for (var i in this.api.zonerankinfos) {
            var unit = this.api.zonerankinfos[i];
            if (Number(unit.zid) == Number(ServerCfg.selectServer.zid)) {
        ...
        var socreText = ComponentManager.getTextField((LanguageManager.getlocal("croessImacyScore-" + this.vo.code) + ': '), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        serveText.text = LanguageManager.getlocal("crossranserver", [currZid + ""]);
