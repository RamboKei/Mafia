...
var AcCrossServerDetailPopupView = (function (_super) {
    ...
    AcCrossServerDetailPopupView.prototype.initView = function () {
        ...
        var topPic = BaseBitmap.create("crossserverinti_detailbg-" + this.vo.code);
        topPic.setPosition(this.viewBg.width / 2 - topPic.width / 2, typeBg.y + 4);
        this.addChildToContainer(topPic);
        //区服排名
        var serverRank = ComponentManager.getTextField(LanguageManager.getlocal("crossImacyOpenDesc3-" + this.vo.code), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_BROWN);
        ...
        var rankDesc = ComponentManager.getTextField(LanguageManager.getlocal("crossImacyDetailDesc1-" + this.vo.code), TextFieldConst.FONTSIZE_CONTENT_SMALL);
        ...
        var persionDesc = ComponentManager.getTextField(LanguageManager.getlocal("crossImacyDetailDesc2-" + this.vo.code), 19);
