...
var AcPunishRankRewardPopupView = (function (_super) {
    ...
    AcPunishRankRewardPopupView.prototype.initView = function () {
        ...
        this._acVo = Api.acVoApi.getActivityVoByAidAndCode(AcPunishRankRewardPopupView.aid, AcPunishRankRewardPopupView.code);
        ...
        //初始化 时间
        var acCfg = Config.AcCfg.getCfgByActivityIdAndCode("punish", AcPunishRankRewardPopupView.code);
        ...
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode("punish", AcPunishRankRewardPopupView.code);
    ...
    AcPunishRankRewardPopupView.prototype.rankBtnClick = function () {
        AcPunishRankPopupView.aid = AcPunishRankRewardPopupView.aid;
        AcPunishRankPopupView.code = AcPunishRankRewardPopupView.code;
        ViewController.getInstance().openView(ViewConst.POPUP.ACPUNISHRANKPOPUPVIEW, { tt: 1 });
    };
    AcPunishRankRewardPopupView.prototype.rankBtnClick2 = function () {
        AcPunishRankPopupView.aid = AcPunishRankRewardPopupView.aid;
        AcPunishRankPopupView.code = AcPunishRankRewardPopupView.code;
        ViewController.getInstance().openView(ViewConst.POPUP.ACPUNISHRANKPOPUPVIEW, { tt: 2 });
    };
    ...
    AcPunishRankRewardPopupView.aid = "";
    AcPunishRankRewardPopupView.code = "";
