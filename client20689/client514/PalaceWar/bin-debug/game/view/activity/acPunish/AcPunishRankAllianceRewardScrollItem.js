...
var AcPunishRankAllianceRewardScrollItem = (function (_super) {
    ...
    AcPunishRankAllianceRewardScrollItem.prototype.initItem = function (index, data) {
        ...
        txt.y = 5;
        this.addChild(txt);
        var rank1TF = ComponentManager.getTextField(LanguageManager.getlocal("acRank_alliance_masterget1"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        rank1TF.x = 10;
        rank1TF.y = 80;
        ...
        var rank2TF = ComponentManager.getTextField(LanguageManager.getlocal("acRank_alliance_memberget"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        rank2TF.x = 10;
