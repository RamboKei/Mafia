...
var AcTailorExchangeView = (function (_super) {
    ...
    AcTailorExchangeView.prototype.initView = function () {
        ...
        var keys = Object.keys(tailorCfg.shop);
        var len = keys.length;
        ...
        ownerTxt.x = GameConfig.stageWidth / 2 + 20;
        ...
        var skinDescTxt = ComponentManager.getTextField(LanguageManager.getlocal("皮肤描述描述描述描述描述描述描述"), 20, TextFieldConst.COLOR_BROWN);
    ...
    AcTailorExchangeView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "tailor_bg2", "tailor_headmask", "public_9_managebg",
        ]);
    };
