...
var WifeScrollItem2 = (function (_super) {
    ...
    WifeScrollItem2.prototype.initItem = function (index, wifeItemCfg) {
        this.width = 640;
        ...
        var icon = BaseLoadBitmap.create(wifeItemCfg.body);
        icon.x = 60;
        //todo icon的宽高尺寸需要固定
        icon.y = 0;
        this.addChild(icon);
        ...
        var nameTF = ComponentManager.getTextField(wifeItemCfg.name, TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        //横版名字变竖版名字
        ...
        var descTF = ComponentManager.getTextField(wifeItemCfg.desc, TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_LIGHT_YELLOW);
        descTF.width = 255;
