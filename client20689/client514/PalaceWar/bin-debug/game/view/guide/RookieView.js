...
var RookieView = (function (_super) {
    ...
    RookieView.prototype.showPage = function () {
        ...
        if (this._curConfig.clickRect) {
            ...
            if (this._curConfig.isScenePos) {
                var curCfg = Config.SceneCfg.getSceneCfgBySceneName(this._curConfig.isScenePos);
    ...
    RookieView.prototype.changeBgCallBack = function () {
        ...
        var bgName = "story_bg" + this._curBgId;
        if (this._curBgId == 5) {
            bgName = "cityscene";
        }
...
__reflect(RookieView.prototype, "RookieView");
