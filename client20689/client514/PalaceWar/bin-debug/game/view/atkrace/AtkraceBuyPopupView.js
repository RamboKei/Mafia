...
var AtkraceBuyPopupView = (function (_super) {
    ...
    AtkraceBuyPopupView.prototype.initView = function () {
        ...
        this._moraleText = ComponentManager.getTextField(Api.atkraceVoApi.getMyInfo().morale.toString(), TextFieldConst.FONTSIZE_CONTENT_COMMON);
