...
var EmperorWarRewardViewTab1 = (function (_super) {
    ...
    EmperorWarRewardViewTab1.prototype.collectHandler = function () {
        // let crossVo = this.vo;
        // NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_AWARD,{activeId: `${crossVo.aid}-${crossVo.code}`});
    };
    EmperorWarRewardViewTab1.prototype.collectHandlerCallBack = function (event) {
    ...
    EmperorWarRewardViewTab1.prototype.tick = function () {
    ...
    EmperorWarRewardViewTab1.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    EmperorWarRewardViewTab1.prototype.createCollectFlag = function () {
