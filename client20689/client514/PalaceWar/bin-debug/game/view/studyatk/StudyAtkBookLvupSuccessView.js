...
var StudyAtkBookLvupSuccessView = (function (_super) {
    ...
    StudyAtkBookLvupSuccessView.prototype.initView = function () {
        ...
        closeBtn.x = this.viewBg.width - closeBtn.width + 20;
        ...
        for (var servantId in servantIdList) {
            ...
            var simg = BaseLoadBitmap.create("servant_full_" + servantId);
            ...
            var bookNameTxt = ComponentManager.getTextField("", 20, TextFieldConst.COLOR_QUALITY_GREEN);
