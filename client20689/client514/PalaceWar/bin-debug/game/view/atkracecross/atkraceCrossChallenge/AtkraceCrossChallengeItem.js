...
var AtkraceCrossChallengeItem = (function (_super) {
    ...
    AtkraceCrossChallengeItem.prototype.challengBtnHandler = function (curr) {
        ...
        if (Api.atkracecrossVoApi.isCanJoin == false) {
            var str = LanguageManager.getlocal("atkraceNoDes");
    ...
    AtkraceCrossChallengeItem.prototype.confirmCallbackHandler = function () {
        ...
        if (AtkraceCrossChallengeItem.data.type == 1) {
            ...
            if (this.haveNumber >= this._needNum) {
                NetManager.request(NetRequestConst.REQUEST_ATKRACECROSS_REVENGE, { "fuid": AtkraceCrossChallengeItem.data.uid, "fzid": AtkraceCrossChallengeItem.data.zid + "", "servantid": this._servantId, "activeId": "" + currActiveId });
...
__reflect(AtkraceCrossChallengeItem.prototype, "AtkraceCrossChallengeItem");
