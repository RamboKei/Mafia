...
var AllianceInfoPopupView = (function (_super) {
    ...
    AllianceInfoPopupView.prototype.initView = function () {
        ...
        var nameStr = LanguageManager.getlocal("allianceInfoName", [allianceVo.name]);
        ...
        var info3Str = LanguageManager.getlocal("allianceInfoLevel", [allianceVo.level.toString(), allianceVo.exp.toString(), allianceCfg.exp.toString()]);
        ...
        var inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_9_bg5", LanguageManager.getlocal("allianceCreateWeixinholder"), 0xb1b1b1, allianceVo.cweixin);
        inputTF2.x = 50;
        ...
        var inputTF3 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_9_bg5", LanguageManager.getlocal("allianceCreateQQholder"), 0xb1b1b1, allianceVo.cqq);
        inputTF3.x = 50;
        ...
        var inputTF4 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 100, "public_9_probiginnerbg", LanguageManager.getlocal("allianceCreateMsgholder"), 0xb1b1b1, allianceVo.message);
        inputTF4.x = 50;
        ...
        var inputTF5 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 100, "public_9_probiginnerbg", LanguageManager.getlocal("allianceCreateMsgholder"), 0xb1b1b1, allianceVo.intro);
        inputTF5.x = 50;
