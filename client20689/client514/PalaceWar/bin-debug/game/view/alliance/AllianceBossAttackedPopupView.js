...
var AllianceBossAttackedPopupView = (function (_super) {
    ...
    AllianceBossAttackedPopupView.prototype.initView = function () {
        ...
        if (dataInfo.type == 3) {
            var descTxt_1 = ComponentManager.getTextField(LanguageManager.getlocal("allianceBossHasKill"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WHITE);
        ...
        var rightScoreTxt = ComponentManager.getTextField(LanguageManager.getlocal("allianceBuildGet3") + App.StringUtil.formatStringColor("+" + dataInfo.exp, TextFieldConst.COLOR_WARN_GREEN), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WARN_GREEN);
