...
var AllianceCreateView = (function (_super) {
    ...
    AllianceCreateView.prototype.initView = function () {
        ...
        var bottomBg = BaseBitmap.create("alliance_bg2");
        bottomBg.x = 0;
        bottomBg.y = -15;
        ...
        //按钮背景
        var btnBg = BaseBitmap.create("public_9_bg9");
        btnBg.width = 180;
        btnBg.height = 290;
        btnBg.x = 430;
        ...
        //创建按钮
        var createBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "allianceCreateCreateBtn", this.createHander, this);
        ...
        //随机按钮
        var randomBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "allianceCreateRandomBtn", this.randomJoinHander, this);
        ...
        //查询按钮
        var searchBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "allianceCreateSearchBtn", this.findHander, this);
        ...
        //排行按钮
        var rankBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "allianceCreateRankBtn", this.rankHander, this);
    ...
    AllianceCreateView.prototype.getResourceList = function () {
