...
var ManageView = (function (_super) {
    ...
    ManageView.prototype.initView = function () {
        ...
        for (var i = 0; i < maxV; i++) {
            ...
            //主线任务引导
            if (!Api.rookieVoApi.isInGuiding && Api.mainTaskVoApi.getCurMainTaskId() == (i + 1).toString() && !Api.mainTaskVoApi.isCurTaskReach()) {
    ...
    ManageView.prototype.updateResNum = function (index, num, isBoom, isOnekeyBoo) {
        ...
        if (!isNaN(index)) {
            ...
            if (refreshText) {
                ...
                App.CommonUtil.playRewardFlyAction(actions, refreshText.localToGlobal(refreshText.width / 2, 0), 600);
            }
        }
        else {
    ...
    ManageView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            ...
            "managebg", "manage_buildingpractice", "manage_practicename", "public_icon12",
