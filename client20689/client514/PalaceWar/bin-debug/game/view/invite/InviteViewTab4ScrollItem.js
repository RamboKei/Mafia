...
var InviteViewTab4ScrollItem = (function (_super) {
    ...
    InviteViewTab4ScrollItem.prototype.initItem = function (index, userPid) {
        ...
        // 区
        var serverTxt = ComponentManager.getTextField(LanguageManager.getlocal("ranserver2", [Api.inviteVoApi.getUserServerByPid(userPid)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
