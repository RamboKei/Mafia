...
var LoginView = (function (_super) {
    ...
    LoginView.prototype.showLogoAndLoginBtn = function () {
        ...
        if (PlatformManager.checkIsShowWarning()) {
            if (!platStr) {
                ...
                this.addChild(warnTxt);
                var platTxt = ComponentManager.getTextField(platStr, 16);
    ...
    LoginView.setLoginByPID = function (pid, psw) {
        var ths = ViewController.getInstance().getView(ViewConst.BASE.LOGINVIEW);
        if (ths) {
            ths.setLoginByPID(pid, psw);
        }
    };
    LoginView.prototype.setLoginByPID = function (pid, psw) {
