...
var ZhubowanghongView = (function (_super) {
    ...
    ZhubowanghongView.prototype.initView = function () {
        ...
        var btnBg = BaseBitmap.create("wifeskin_barbg");
        btnBg.x = 0;
        btnBg.y = GameConfig.stageHeigth - this.container.y - btnBg.height;
        this.addChildToContainer(btnBg);
        // 寻访按钮
        var goXunfangBtn = ComponentManager.getButton(ButtonConst.BTN_BIG_YELLOW, "zhubowanghong_goXunfang", this.xunfangButtonHandler, this);
