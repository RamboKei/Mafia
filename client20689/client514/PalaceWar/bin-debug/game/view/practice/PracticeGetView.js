...
var PracticeGetView = (function (_super) {
    __extends(PracticeGetView, _super);
    function PracticeGetView() {
        return _super.call(this) || this;
    }
    PracticeGetView.prototype.initView = function () {
        var pnum = this.param.data.pnum;
        ...
        var finishWord = BaseBitmap.create("practice_get_word");
        ...
        var startY = descBg.y + 40;
        var startX = descBg.x + 30;
        var practice_getTxt1 = ComponentManager.getTextField("", 24, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        startY += 40;
        var practice_getTxt2 = ComponentManager.getTextField("", 24, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        var vipAdd = basecfg.vip[pvip - 1];
        var vipAdd2 = basecfg.vip[pvip];
        ...
        var uiList = [
            {
                node1: ComponentManager.getBitmapText(Api.playerVoApi.getPlayerOffice(), "office_fnt"),
    ...
    PracticeGetView.prototype.btnHandler = function (param) {
        // egret.log("param >>>>>>");
        if (param == 0) {
    ...
    PracticeGetView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "dinner_list_bg",
            "tailor_get_light", "office_fnt", "monthcard_icon", "yearcard_icon", "public_line1", "practice_get_word",
        ]);
    };
    PracticeGetView.prototype.getBgName = function () {
        return "public_9_bg8";
    };
    PracticeGetView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return PracticeGetView;
}(BaseView));
__reflect(PracticeGetView.prototype, "PracticeGetView");
