...
var ScrollListItem = (function (_super) {
    ...
    ScrollListItem.prototype.init = function (index, data) {
        this._index = index;
        this.__data = data;
    ...
    ScrollListItem.prototype.initItem = function (index, data) {
    };
    /**
     * 不同格子X间距
     */
     ...
     * @param data 数据
     */
    ScrollListItem.create = function (classDomin, index, data) {
        ...
        var scrollListItem = ScrollListItem.scrollListItemPool[targetClassName].pop();
        if (!scrollListItem) {
