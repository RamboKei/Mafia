...
namespace ComponentManager 
{
	 ...
	 */
	export function getScrollList(scrollListClass:{new();},dataList:any[],scrollRect:egret.Rectangle):ScrollList
	{
	 ...
	 * @param fontName      fnt
	 */
	export function getBitmapText(textStr:string,fontName:string):BaseBitmapText
	{
