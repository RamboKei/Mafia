...
class AllianceFindPopupView extends PopupView
{
	...
	{	
		...
		let inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE,TextFieldConst.FONTSIZE_TITLE_SMALL,466,44,"public_9_bg5",LanguageManager.getlocal("allianceFindInputHolder"),0xa4917f);
	...
	private showFindInfo():void
	{
		...
		this._scrollView.setPosition(50, 210);
		// scrollView.y= 100;
