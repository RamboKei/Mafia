...
class ChallengeButton extends BaseButton
{
	...
	public initButton(callback:Function,handler:any,idx:number)
	{
		this._idx = idx;
	...
	private showBoss():void
	{
		...
		let challengeConfig:any = ChallengeCfg.getChallengeCfgById(Api.challengeVoApi.getCurBigChannelId()*41);
