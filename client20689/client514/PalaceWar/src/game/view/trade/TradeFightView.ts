...
class TradeFightView  extends CommonView
{
    ...
    public initView():void
	{
		...
		let servant_infoPro2 = BaseBitmap.create("servant_infoPro2");
		this.addChild(servant_infoPro2);
		servant_infoPro2.scaleX=0.5;
		servant_infoPro2.scaleY=0.5;
		...
		intelligenceTxt.text =Api.playerVoApi.getInte()+"";
