...
class BattleView extends CommonView
{
	...
	{	
		...
		{	
			 ...
			 oneMan.speed = 150 + App.MathUtil.getRandom(0,50);
	...
	protected initRightSoldiers():void 
	{
		...
		{	
			 ...
			 oneMan.speed = 100 + App.MathUtil.getRandom(0,50);
			 oneMan.myIndex = i;
	...
	private shakeScreen(timeStamp:number):boolean
	{
        ...
        {   
            ...
            this._battleBg.y =-5-App.MathUtil.getRandom(0,10);
		}
		 return false;
	}	
