...
class InviteViewTab4ScrollItem  extends ScrollListItem
{
    ...
    protected initItem(index:number,userPid:string)
    {
        ...
        // 区
        let serverTxt = ComponentManager.getTextField(LanguageManager.getlocal("ranserver2", [Api.inviteVoApi.getUserServerByPid(userPid)]),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN)
