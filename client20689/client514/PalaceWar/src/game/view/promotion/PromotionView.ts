 ...
 class PromotionView extends CommonView
{
	...
	{	
		...
		for (var index = 0; index < uiCfg.length; index++) {
			...
			if (topUIOver == false)
			{
				...
				promotion_officerbg1 = BaseBitmap.create("promotion_officerbg1");
		...
		this._progressBar = ComponentManager.getProgressBar("progress3","progress3_bg",566);//,562,19);
	...
	protected getResourceList():string[]
	{
		return super.getResourceList().concat( [
			"playerview_bg2","promotion_officerbg1","promotion_arrow",
