...
class RechargeVipViewScrollltem extends ScrollListItem {
	...
	private _acerImg:BaseBitmapText =null;
    ...
    {	
		...
		let msgTF:BaseBitmapText = ComponentManager.getBitmapText((data.gemCost?data.gemCost:data.firstGet)+elementStr2,"recharge2_fnt");
