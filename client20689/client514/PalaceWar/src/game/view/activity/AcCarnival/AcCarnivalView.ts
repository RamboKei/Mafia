...
class AcCarnivalView  extends CommonView
{
	...
	public initView():void
	{
        ...
        // App.MessageHelper.addEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_PAY_RROCCESSPAYMENT),this.checkRedpoints,this);
    ...
    protected getResourceList():string[]
	{
		return super.getResourceList().concat([
            ...
            // "activity_charge_red",
            // "activity_charge_dailyCharge",
            // "activity_charge_totalDayRecharge",
            // "activity_charge_totalRecharge",
	...
	public dispose():void
	{
        ...
        // App.MessageHelper.removeEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_PAY_RROCCESSPAYMENT),this.checkRedpoints,this);
