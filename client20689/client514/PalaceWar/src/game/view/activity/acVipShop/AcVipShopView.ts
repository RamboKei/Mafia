...
class AcVipShopView extends AcCommonView
{
	...
	public initView():void
	{
        ...
        let topBg:BaseBitmap = BaseBitmap.create("activity_vipshop_topbg");
        ...
        if(this._cfgObj)
        {
            ...
            let scrollList = ComponentManager.getScrollList(AcVipShopViewScrollItem,this._itemArr,tmpRect);
