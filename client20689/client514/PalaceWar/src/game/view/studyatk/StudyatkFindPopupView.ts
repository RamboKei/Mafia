...
class StudyatkFindPopupView extends PopupView
{
	...
	{	
		...
		let inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE,TextFieldConst.FONTSIZE_TITLE_SMALL,466,44,"public_chatinputbg",LanguageManager.getlocal("inputPlayerId"),0xa4917f);
	...
	private showFindInfo():void
	{
		...
		for (var index = 0; index < txtCfg.length; index++) {
			let findText:BaseTextField = ComponentManager.getTextField("",TextFieldConst.FONTSIZE_CONTENT_COMMON);
