...
class ConquestBatchPopupView  extends PopupView
{
	...
	protected initView():void
	{
		...
		// this._maxNum = 200;
		let iconBg3:BaseBitmap=BaseBitmap.create("mainui_topresbg");
		iconBg3.setPosition(40,20);
		...
		attText.setPosition(70,iconBg3.y + iconBg3.height/2 - attText.height/2);
