class AtkracecrossView extends CommonView
{
	...
	{	
		...
		let rewardDesc:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("atkracecrossRewardDesc",[String(Api.atkracecrossVoApi.zonerankinfos[0].zid)]),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
