...
class ActrackCrossMoreItem extends ScrollListItem {
	...
	protected initItem(index: number, data: any) 
    {
		...
		let zidStr = LanguageManager.getlocal("atkraceCrossServeDes",[data.info.zid+""]);//data.zid
		...
		if(Api.playerVoApi.getPlayerID()==data.info.uid||data.info.zid==ServerCfg.selectServer.zid)
		{
