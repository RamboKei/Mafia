...
class PlayerVoApi extends BaseVoApi
{
	...
	{	
		...
		let myBody = BaseLoadBitmap.create(picStr + picId,rect,{callback:loadComplete,callbackThisObj:this,callbackParams:[container]});
	 ...
	 * @param pic 用户头像id
	 */
	public getPlayerCircleHead(pic:number,title:string = "-1"):BaseDisplayObjectContainer
	{	
